...
("fish finger", "🍱"),("chicken nugget", "🍱"),("oven chip", "🍟"),("frozen pea", "🧊"),("frozen berry", "🧊"),
("frozen veg", "🧊"),("sandwich", "🥪"),("sub", "🥪"),("taco", "🌮"),("burrito", "🌯"),("tamale", "🫔"),
...
// Maps a grocery item name to a playful emoji. ~%d keyword→emoji entries spanning
// produce, proteins, dairy, bakery, grains, pantry, drinks, snacks, frozen,
// prepared dishes and household/toiletry/baby/pet/health goods.
enum Emoji {
...
%s,
    ...
    private static let complexKeywords: [(String, String)] =
        table.filter { $0.0.contains(where: { !$0.isLetter }) }
...
out = sys.argv[1] if len(sys.argv) > 1 else "Sources/Services/Emoji.swift"
